...
class AboutClasses(Koan):
    ...
    def test_that_name_can_be_read_as_a_property(self):
        ...
        # access as method'Dogs need regular walkies. Never, ever let them drive.'
    ...
    def test_inside_a_method_self_refers_to_the_containing_object(self):
        ...
        # self.assertEqual("<Dog named '", fido.get_self())  # Not a string!'Dogs need regular walkies. Never, ever let them drive.'
    ...
    def test_str_is_used_explicitly_in_string_interpolation(self):
        ...
        self.assertEqual("My dog is Fido", "My dog is Fido")
